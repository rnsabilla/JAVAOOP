...
public class Stack 
{
    ...
    private static void menuProgram()
    {
        ...
        while(loopX == 0)
        {
            System.out.println("\nProgram Stack dengan Java");
            System.out.println("Menu: ");
            System.out.println("1. Menambah Stack");
            System.out.println("2. Mengeluarkan 1 data dari Stack");
            System.out.println("3. Status Stack");
            System.out.println("4. Menampilkan data dalam Stack");
